...
#This program also tells the user a messege if they put an invalid input for the multiple choice quesions. 
...
#checks that the user's answer is b or c
elif answer1 == "b" or answer1 == "c":
    print("The correct answer was a") #outputs the correct answer
# checks that the user's answer is something other than a, b, or c
else:
...
if answer4 == "b":
    score = score + 1 # adds one to the current score
    print("Correct!") # outputs that the user's answer is correct
#checks that the user's answer is a or c
...
if answer6 == "c":
    score = score + 1 # adds one to the current score
    print("Correct!") #outputs that the user's answer is correct
# checks that the user's answer is a or b
