...
#This program reads the document of Alice.txt and counts and outputs
#the specified words and unqie words.
# import wordle
import string
...
class Count:
        ...
        def increment_count(self,word):
                #covert word to lower case
            word = word.lower()
            #strips off punctuation from the word
        ...
        def lookup_count(self,word):
            ...
            if word in self.word_counts:
                    #returns the count of the word from the dict
...
##        print(counter.lookup_count(""))
        ...
        #prompts the user to enter a file name, here we want to open Alice.txt
        filename = input("Enter book file:")
        #opens the file for reading
        infile = open(filename)
        #loops for each line in the file, splitting on the space and
        ...
        for line in infile:
            ...
            for word in line:
                    #increments the count of the specified word
        ...
        ## After completing Part 6 remove these lines
                #outputs the count for each specified word from the
                #Alice.txt
