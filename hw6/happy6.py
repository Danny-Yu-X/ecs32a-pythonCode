...
# and reads the input file world_pop_gdp.tsv file and outputs the
#country name, population in millions, GDP per capita, and Happiness
#for the countries that have a population greater than 100 million
...
#for each line, printing out the country name, population in mil, and GDP,
# per captia for the countries that have a population greater than 100 mil
...
def read_gdp_data(happy_dict):
    ...
    #for the countries that have a population greater than 100 mil
    #loops until the last line of the file
    ...
    for line in infile:
        ...
        #convert population to a floating point number
        population = float(population)
        #checks if the country from world_pop_gdp.tsv is a key in happy_dict
        #and if the population is greater than 100 million
        if country in happy_dict and population > 100:
    ...
    #outputs country, population in millions, Gdp per capita, and happiness
            print(country + ",{:.2f},".format(population) + gdp + "," + happy_index)
    return
