...
#The program also opens an outfile and writes the values into that file
...
#writes a header for the outfile file
...
for index in range(k, len(temp_list) - k):
    ...
    #write year,average to the outfile
    outfile.write("{:.0f},".format(year) + "{:.4f}".format(ave)+"\n")
